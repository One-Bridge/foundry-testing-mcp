                        ...
                        "todos": [
                            {
                                ...
                                "success_criteria": "✅ Receive foundry.toml with via_ir=true and optimizer=true",
                                "time_estimate": "5 minutes",
                                "why_mandatory": "🛡️ PREVENTS: Stack too deep errors and compilation failures before testing"
                            },
                            {
                                "id": 1,
                                "priority": "CRITICAL",
                        ...
                        "todos": [
                            {
                                "id": 0,
                                "priority": "CRITICAL",
                                "description": "**Call `validate_foundry_config` before coverage analysis**",
                                "tool_call": "validate_foundry_config(prevent_stack_errors=True)",
                                "expected_output": "Foundry configuration validation with compilation optimization",
                                "success_criteria": "✅ Foundry.toml has via_ir and optimizer enabled for complex contracts",
                                "time_estimate": "3 minutes",
                                "why_mandatory": "🛡️ PREVENTS: Coverage analysis failures due to stack too deep compilation errors"
                            },
                            {
                                "id": 1,
                                "priority": "HIGH",
